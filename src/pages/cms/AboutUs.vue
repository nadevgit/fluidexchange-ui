      ...
      <div class="content_wrapper">
        ...
        <div class="content1">
          <h5>{{$t('cms.contactus')}}</h5>
           <p>{{$t('description.service')}}：{{$t('web.service')}}</p>
          <p>{{$t('description.support')}}：{{$t('web.support')}}</p>
          <p>{{$t('description.apply')}}：{{$t('web.apply')}}</p>
          <p>{{$t('description.report')}}：{{$t('web.report')}}</p>
          <p>{{$t('description.coop')}}：{{$t('web.coop')}}</p>
        </div>
        <!--div class="content1" style="border:none;">
          <h5>{{$t('description.community')}}</h5>
          <p>{{$t('description.wechat')}}：{{$t('description.addwechat')}}</p>
          <p>{{$t('description.weibo')}}：https://weibo.com/BZEEX</p>
          <p>{{$t('description.twitter')}}：https://twitter.com/BZEEXGlobal</p>
          <p>{{$t('description.biyong')}}：https://0.plus/BZEEXofficial</p>
          <p>{{$t('description.telegram')}}：https://t.me/BZEEXofficial</p>
          <p>{{$t('description.medium')}}：https://medium.com/@BZEEX</p>
          <p>{{$t('description.reddit')}}：https://www.reddit.com/u/BZEEXglobal</p>
        </div-->
      </div>
    </div>
  </div>
