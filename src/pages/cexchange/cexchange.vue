                      ...
                      <div class="panel panel_buy">
                        <div class="bd bd_limited">
                          <div style="min-height: 65px;width:100%;margin-bottom: 30px;padding: 10px 10px;border-radius: 5px;background: #0b1520;">
                            ...
                            <div style="width:50%;float:left;">
                              <h3>1 OTR ≈ {{currentPriceShow}} {{baseCoinUnit}}</h3>
                          ...
                          <Form style="width: 60%;margin-left:20%;">
                            <FormItem class="buy-input">
                              ...
                              <div class="quantity-group">
                                <div :class="{ 'quantity-item': true, 'current': currentType == 1 }" @click="selectCount(1500, 1)"> 1500 OTR</div>
                                <div :class="{ 'quantity-item': true, 'current': currentType == 2 }" @click="selectCount(1000, 2)">1000 OTR</div>
                                <div :class="{ 'quantity-item': true, 'current': currentType == 3 }" @click="selectCount(500, 3)">500 OTR</div>
                                <div :class="{ 'quantity-item': true, 'current': currentType == 4 }" @click="selectCount(150, 4)">150 OTR</div>
                                ...
                                <div style="float:left;margin-top: 30px;margin-left:15px;">
                                  <Input style="width:100%;" v-model="promotionCode"  size="large" :placeholder="$t('cexchange.inputtips2')"></Input>
                                </div>
                              </div>
                            </FormItem>
                            <FormItem class="trade-input">
                              ...
                              <RadioGroup v-model="baseCoinUnit" style="text-align:left;margin-left:215px;float:left;">
                                  ...
                                  <!--  <Button style="width: 60px;margin-left:10px;" type="primary" @click="allBy(0)" size="small">{{$t('cexchange.all')}}</Button>-->
                                    <span style="margin-left: 20px;">1 OTR ≈ {{usdtRate}} USDT</span>
                                  </Radio><br/></div>
                                  <div><Radio label="BTC" style="margin-bottom:10px;">
                                   ...
                                   <!-- <Button style="width: 60px;margin-left:10px;" type="primary" @click="allBy(1)" size="small">{{$t('cexchange.all')}}</Button>-->
                                    <span style="margin-left: 20px;">1 OTR ≈ {{btcRate}} BTC</span>
                                  </Radio><br/></div>
                                  <div><Radio label="ETH">
                                   ...
                                   <!-- <Button style="width: 60px;margin-left:10px;" type="primary" @click="allBy(2)" size="small">{{$t('cexchange.all')}}</Button>-->
                                    <span style="margin-left: 20px;">1 OTR ≈ {{ethRate}} ETH</span>
                                  </Radio><br/></div>
                              </RadioGroup>
                            </FormItem>
                            <FormItem>
  ...
  methods: {
    ...
    confirm(){
      ...
      if(this.promotionCode == ''){
        this.$Message.error("Exchange code cannot be empty");
        return;
      }
      this.modal = true;
    },
    ...
    submit(){
      ...
      params.exchangeCode = this.promotionCode;
