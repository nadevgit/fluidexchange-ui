<template>
  <div>
    <div id="fullpage">
      ...
      <div class="section" id="pagfullpagee1">
        <!-- <div v-if="lang==='简体中文'"> -->
        ...
        <div class="agent-panel">
          ...
          <div class="agent-list">
            <div class="agent-item">
              ...
              <router-link to="//exchange/btc_usdt" target="_blank">
            ...
            <div class="agent-item">
              ...
              <router-link to="/swap/btc_usdt" target="_blank">
                <div class="agent-detail">
            ...
            <div class="agent-item">
              ...
              <router-link to="/cexchange" target="_blank">
                <div class="agent-detail">
      ...
      <div style="width: 100%;background: #141e2c;display:none;">
        <router-link to="/announcement/118930" target="_blank" style="width: 100%;">
          <img src="https:// FLUID.oss-cn-hongkong.aliyuncs.com/bannerimg.png" style="width: 72%;margin-left: 14%;margin-top: 20px;">
        </router-link>
      </div>
