  ...
  <div class="login_form mob-login">
    <div class="login_right">
      <div style="color: #F90;margin-bottom: 60px;margin-top: 60px;">
        <h1 style="border-left: 5px solid #F90;padding-left: 10px;letter-spacing: 2px;line-height:30px;height:30px;">{{$t('web.webname')}}</h1>
      ...
      <Form v-if="allowRegister" ref="formInline" :model="formInline" :rules="ruleInline" inline>
        ...
        <FormItem>
         ...
         <!--Button class="register_btn" @click="tz()" :disabled="registing">点我下载app体验</Button-->
        </FormItem>
      </Form>
    </div>
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      window.document.title = (this.lang == "zh_CN" ? "新用户注册 - " : "New Register - ") + "FLUID | Global digital currency trading platform";
      // this.getAreas();
      // this.initGtCaptcha();
    },
    initGtCaptcha() {
