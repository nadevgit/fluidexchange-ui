    ...
    <div class="footer">
      <div class="footer_content">
        <div class="footer_left">
          <img  src="./assets/images/logo-bottom.png" style="margin:0" width="232px" height="44px" ></img>
          <!-- <h3>Caymanex.Pro</h3> -->
          <p style="letter-spacing:2px;">{{$t("footer.gsmc")}}</p>
          <p> © 2022 FLUID Finance All rights reserved.&nbsp;&nbsp;</p>
          <div class="social-list">
            <ul>
              ...
              <Tooltip content="https://weibo.com/ FLUID" theme="dark" placement="top">
                <li>
                  <Icon custom="i-icon iconfont iconweibo" />
                </li>
              </Tooltip-->
              <Tooltip content="https://twitter.com/ FLUIDGlobal" theme="dark" placement="top">
                <li>
                  <Icon type="logo-twitter" />
                </li>
              </Tooltip>
              <Tooltip content="https://medium.com/@ FLUID" theme="dark" placement="top">
                <li>
                  <Icon custom="i-icon iconfont iconmedium" />
                </li>
              </Tooltip>
              <Tooltip content="https://www.reddit.com/u/ FLUIDglobal" theme="dark" placement="top">
                <li>
     ...
     <!--   <div class="footer_right" style="margin-left: 5%;border-left: 1px solid #243051;padding-left: 5%;">
        ...
        <div class="footer_right">
          ...
          <ul>
            ...
            <li class="wechatclick">
              <poptip width="220" trigger="hover" placement="right">
                <a href="javascript:;" class="wechat">{{$t("footer.kfyx")}}</a>
                <div slot="content">
                  <p style="text-align:center;">{{$t("web.gmail")}}</p>
                </div>
              </poptip>
            </li>
            <li class="wechatclick">
...
export default {
  ...
  watch: {
    activeNav: function() {
      switch (this.activeNav) {
        case "nav-exchange":
          window.document.title = (this.lang == "zh_CN" ? "交易中心" : "Exchange") + " - FLUID | FLUID | Global digital currency trading platform";
          break;
        case "nav-service":
          window.document.title = (this.lang == "zh_CN" ? "公告" : "Announcement") + " - FLUID | FLUID | Global digital currency trading platform";
          break;
        case "nav-about":
          window.document.title = (this.lang == "zh_CN" ? "关于" : "About") + " - FLUID | FLUID | Global digital currency trading platform";
          break;
        case "nav-lab":
          window.document.title = (this.lang == "zh_CN" ? "创新实验室" : "Lab") + " - FLUID | FLUID | Global digital currency trading platform";
          break;
        case "nav-invite":
          window.document.title = (this.lang == "zh_CN" ? "推广合伙人" : "Promotion") + " - FLUID | FLUID | Global digital currency trading platform";
          break;
	case "nav-cexchange":
          window.document.title = (this.lang == "zh_CN" ? "活动" : "Activity") + " - FLUID | Global digital currency trading platform";
          break;
        default:
          window.document.title = "FLUID | FLUID - Global digital currency trading platform";
          break;
      }
    },
    $route(to, from) {
  ...
  computed: {
    ...
    languageValue: function() {
      ...
      // var curlang = 'zh_CN'
      console.log(curlang,'sdwerwqeqweqwe')
...
　　let flag = navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i)
	...
	getUrl(type){
		if(type==1){
			...
			return "/helpdetail?cate=5&id=19&cateTitle="+this.$t("footer.mztk");
		}else if(type==7){
			return "/helpdetail?cate=5&id=28&cateTitle="+this.$t("footer.ystk");
		}else if(type==8){
			return "/helpdetail?cate=5&id=36&cateTitle="+this.$t("footer.fwtk");
		}else if(type==9){
			return "/helpdetail?cate=5&id=45&cateTitle="+this.$t("footer.fltk");
		}
