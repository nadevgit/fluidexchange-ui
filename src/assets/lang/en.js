module.exports = {
    common: {
        ...
        set: 'Set',
        update: 'Modify',
        slogan: "The World Top Liquidity Aggregator For Digital Assets",
        subslogan: "",
        more: "More",
        please: "Please",
        nodata: "No Records",
    ...
    sectionPage: {
        ...
        brandTitle: "About  FLUID",
        brandDetail: "Honest  |  Fair  |  Enthusiasm  |  Open",
        brandDesc1: "FLUID was founded by a group of early Bitcoin participants and geeks. The core members of the team are from well-known enterprises such as Google, Microsoft, Alibaba, Tencent and so on. It has deep research and development strength and rich experience in Internet product operation.",
        brandDesc2: "FLUID is located in the basic service provider of block chain, dedicated to providing high-quality encrypted assets trading platform for global users, adhering to the basic principle of “DO NOT BE EVIL”, upholding honest, fair and enthusiastic service to customers, and welcoming all partners/projects that are beneficial to the fundamental interests of users with an open attitude.",
        gettingstart: "HOT | Beginner's Guide",
        officialstart: "FLUID Official Customer Service",
    ...
    ctc: {
        ...
        desc:"Crypto assets are managed by  FLUID, and the acceptor provides exchange services for exchange.",
        buyin: "Buy",
        sell: "Sell",
        buyprice: "Buy Price",
        sellprice: "Sell Price",
    ...
    cexchange: {
        title: "OTR Activity",
        desc: "OTR Coin ● One-click ● Profit everyday",
        quantity: "ActivityPurchase Quantity",
        inputtips1: "The number of custom",
        inputtips2: "Financial Institution Code",
        ...
        confirmmsg: "Are you sure to exchange FLUID?",
        ok: "OK",
        cancel: "Cancel"
    },
    option: {
    ...
    activity: {
        ...
        attentiontxt4: "* The right of final interpretation of this activity belongs to the official ownership of  FLUID.",
        ...
        submit: "Submit",
        tipsmobile: "Please use PC web（FLUID.Finance）",
    ...
    invite: {
        ...
        ruleprofile1:"[Promotion Partner] is the highest proportion of online Commission return and the longest time of commission return (maximum lifetime commission). Promoters who make corresponding efforts can become real platform ‘partners’ and enjoy the dividend of growing together with FLUID trading platform. Detailed rules are as follows:",
        ruleprofile2:"",
        ruleprofile3:"",
        ruleprofile4:"",
        ruletext1: "1、In order to preach the concept of digital assets and expand the scale of users, FLUID launched the “Promotion Partner” program, which is effective for a long time.",
        ...
        ruletext11: "11、The right of final interpretation of this activity belongs to  FLUID.",
        ...
        thanks: "Thank you for supporting  FLUID！",
        ...
        pt_tips: "If you have a good idea, please send an email to promotion@ FLUID.cc, with a reward after adoption.！",
        ...
        pt_card_rule6: "6. The right of final interpretation of free gift cards belongs to  FLUID.cc.",
        pt_card_day: "Days",
    ...
    uc: {
        ...
        identity: {
            ...
            become: "Become FLUID Certified Business and enjoy more transaction privileges",
        ...
        promotion: {
            ...
            exchangesuccess: "Congratulations！You can check the asset in Finance center！",
             realNameStatus: "No real name",
            realNameStatus2: "Real name already",
    ...
    cms: {
        ...
        download: "Download",
        downloadslogan: "FLUID APP - Trade everywhere."
    },
    description: {
        title1: 'Security',
        title2: '24H Service',
        ...
        aboutdesc1: " FLUID.cc is a leading digital asset trading platform in the world, registered in the Cayman Islands, with a core operating team in Hong Kong. The core members of  FLUID.cc come from top Internet and financial companies. Most of them are deep believers in Bitcoin and block chains. We are convinced that block chains will change the traditional monopolistic financial system and build a more democratic and autonomous social structure.",
        aboutdesc2: " FLUID.cc platform has a professional financial-level trading architecture, a self-developed high concurrent memory matching trading engine. The platform uses a full-cold rechargeable wallet system + multiple signatures + high-protection DDOS attack system and other trading architecture to ensure customer asset security.",
        aboutdesc3: "In order to let customers better grasp the investment opportunities,  FLUID.cc adopts flat management in customer service department, and establishes an extremely fast service response mechanism. The asset customer service manager is on-line 7*24H all the year round, providing customers with services such as recharge and cash of assets, and ensuring that customers complete recharge in 25 minutes.",
        aboutdesc4: " FLUID.cc strictly screens high-quality projects and provides secure and stable asset hosting services.  FLUID.cc upholds the concept of “honesty, justice, enthusiasm and openness”, and strives to create a safe, reliable, efficient and friendly ultimate exchange for users.",
        ...
        wechat: "Wechat",
        addwechat: "Add ' FLUID01' as Wechat friends and then enter Wechat community",
        weibo: "Weibo",
        twitter: "Twitter",
        biyong: "Biyong",
        telegram: "Telegram",
    ...
    index: {
        ...
        BHBregister: "FLUID account registration",
        ...
        fenpeijizhi: 'A description of the FLUID income distribution mechanism',
    ...
    plate: {
        ...
        content1: "As described in the white paper, FLUID will take up 80% of the platform (after deduct Taxes and fees )The income is allocated to BHB holders, and 20% of revenue is used to support R & D and operation of the platform.",
