module.exports = {
    ...
    sectionPage: {
        ...
        brandDesc1: " FLUID.cc由一群比特币早期参与者与极客创立，团队核心成员来自于谷歌、微软、阿里巴巴、腾讯等知名企业，具有深厚的研发实力与丰富的互联网产品运营经验。",
        brandDesc2: " FLUID.cc定位于区块链基础服务商，致力于为全球用户提供优质加密资产交易平台，秉承着“不作恶”的基本原则，坚持诚实、公正、热情的服务于客户，以开放的态度迎接一切有利于用户根本利益的伙伴/项目。",
    ...
    invite: {
        ...
        pt_more: "更多工具，敬请期待",
        pt_tips: "如果您有好的创意，请发送邮件至promotion@ FLUID.cc，采纳后有奖励哦！",
        pt_card_amount: "卡面金额",
        ...
        pt_card_rule6: "六、免费礼品卡最终解释权归 FLUID.cc所有。",
        pt_card_day: "天",
    ...
    description: {
        ...
        community: "FLUID社区",
        wechat: "微信",
        addwechat: "添加 “ FLUID01” 为微信好友，进入微信福利社群",
        weibo: "微博",
        twitter: "推特",
        biyong: "币用",
        telegram: "电报",
    ...
    FLUID_description: {
        ...
        desc4: "参与 FLUID社区投票活动，包括但不限于上币、回购等",
    ...
    index: {
        ...
        fenpeijizhi: '关于 FLUID收入分配机制的说明',
        jiangli_jihua: "邀请挖矿奖励计划",
        friend_fanhuan: "邀请好友、赚取额外手续费返还"
    },
    plate: {
        title: "平台收入分配方案 (BHB 持有者权益)",
        content1: "正如白皮书所描述的， FLUID会拿出平台的80% (扣除税费后) 的收入分配给 FLUID持有者，20%的收入用来支持平台的研发及运营。",
